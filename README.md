...
这是给 `lya.net.cn` 准备的李予安、李予恩家庭照片/视频浏览网站。主页可分别浏览“李予安”“李予恩”“两人一起”三本相册，家庭上传功能使用 EdgeOne Pages 云函数和 Blob 存储，不需要单独购买虚拟主机或云服务器。

## 家庭成员直接上传

网站的 `/upload/` 页面支持手机和电脑上传。上传人输入正确的家庭密码后，必须选择“李予安”“李予恩”或“两人一起”，照片会直接发布到对应相册，不经过管理审核。
